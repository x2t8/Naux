...
NAUX Learn 0.1.4 is an unsigned experimental pre-release for Linux x86-64 GNU.
...
The bootstrap is pinned to version `0.1.4`, verifies the archive SHA-256, asks
...
[GitHub pre-release](https://github.com/x2t8/Naux/releases/tag/v0.1.4-learn).
