...
examples. NAUX Learn 0.1.4 is available as a Linux x86-64 GNU experimental
...
| Removal | [Uninstall](05-uninstall.md) | Remove 0.1.4 using its sealed receipt |
...
0.1.4 publishes Linux assets only.
