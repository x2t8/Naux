...
def emit_rocq(certificate: Certificate) -> str:
    ...
    lines = [
        ...
        "From NauxCore Require Import ResidencyExactClaim ResidencyExactClaimSoundness.",
    ...
    lines.extend([
        ...
        "  exact wp8s_exact_observation_is_admitted. Qed.",
        "Corollary wp8s_observation_has_full_coverage :",
        "  map exact_kernel_number (exact_kernels wp8s_observation) =",
        "    [1%nat; 2%nat; 3%nat; 4%nat] /\\",
        "  List.length (List.concat (map exact_samples (exact_kernels wp8s_observation))) = 120%nat.",
        "Proof. apply exact_admitted_observation_has_full_coverage.",
        "  exact wp8s_exact_observation_is_admitted. Qed.",
        "Corollary wp8s_observation_satisfies_declarative_spec :",
        "  exact_family_spec (exact_kernels wp8s_observation).",
        "Proof. apply exact_admitted_observation_satisfies_spec.",
        "  exact wp8s_exact_observation_is_admitted. Qed.",
        "",
    ])
    return "\n".join(lines)
