...
def emit_rocq(report: PublicProtocolReport, authority_seal: str) -> str:
    ...
    return "\n".join(
        [
            ...
            "",
            "Lemma wp8q_ci_run_identity_nonempty : wp8q_ci_run_identity <> [].",
            "Proof. discriminate. Qed.",
            "",
            "Lemma wp8q_formal_model_run_identity_nonempty :",
            "  wp8q_formal_model_run_identity <> [].",
            "Proof. discriminate. Qed.",
            "",
            "Lemma wp8q_formal_bridge_run_identity_nonempty :",
            ...
            "         wp8p_static_claim_protocol_is_admitted;",
            "       residency_public_protocol_commit_is_sha1 := eq_refl;",
            "       residency_public_protocol_ci_run_nonempty :=",
            "         wp8q_ci_run_identity_nonempty;",
            "       residency_public_protocol_formal_model_run_nonempty :=",
            "         wp8q_formal_model_run_identity_nonempty;",
            "       residency_public_protocol_formal_bridge_run_nonempty :=",
            "         wp8q_formal_bridge_run_identity_nonempty;",
            "       residency_public_protocol_ci_commit_exact := eq_refl;",
            "       residency_public_protocol_formal_model_commit_exact := eq_refl;",
            "       residency_public_protocol_formal_bridge_commit_exact := eq_refl;",
            "       residency_public_protocol_ci_success_exact := eq_refl;",
            "       residency_public_protocol_formal_model_success_exact := eq_refl;",
            "       residency_public_protocol_formal_bridge_success_exact := eq_refl;",
            "       residency_public_protocol_records_are_public := eq_refl;",
            "       residency_public_protocol_static_review := eq_refl;",
            "       residency_public_protocol_blockers_exact := eq_refl;",
            "       residency_public_protocol_no_request := eq_refl;",
            "       residency_public_protocol_no_approval := eq_refl;",
            "       residency_public_protocol_network_forbidden := eq_refl;",
            "       residency_public_protocol_clock_forbidden := eq_refl;",
            "       residency_public_protocol_build_forbidden := eq_refl;",
            "       residency_public_protocol_execution_forbidden := eq_refl;",
            "       residency_public_protocol_admission_forbidden := eq_refl;",
            "       residency_public_protocol_claim_forbidden := eq_refl |}.",
            "Qed.",
            "",
