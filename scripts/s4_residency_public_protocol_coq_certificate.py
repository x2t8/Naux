...
def emit_rocq(report: PublicProtocolReport, authority_seal: str) -> str:
    ...
    return "\n".join(
        [
            ...
            "Proof.",
            "  unfold wp8q_public_protocol_receipt.",
            "  constructor.",
            "  - exact wp8p_static_claim_protocol_is_admitted.",
            "  - reflexivity. (* commit width *)",
            "  - exact wp8q_ci_run_identity_nonempty.",
            "  - exact wp8q_formal_model_run_identity_nonempty.",
            "  - exact wp8q_formal_bridge_run_identity_nonempty.",
            "  - reflexivity. (* CI commit *)",
            "  - reflexivity. (* formal-model commit *)",
            "  - reflexivity. (* formal-bridge commit *)",
            "  - reflexivity. (* CI success *)",
            "  - reflexivity. (* formal-model success *)",
            "  - reflexivity. (* formal-bridge success *)",
            "  - reflexivity. (* public records *)",
            "  - reflexivity. (* static review *)",
            "  - reflexivity. (* remaining blockers *)",
            "  - reflexivity. (* no request *)",
            "  - reflexivity. (* no approval *)",
