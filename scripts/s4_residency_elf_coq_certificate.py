    ...
    for kernel in kernels:
        ...
        rows.extend(
            [
                ...
                f"  length {wp8e_target} = {_coq_nat(kernel.target_bytes)}.",
                "Proof. vm_compute. reflexivity. Qed.",
                "",
                ...
                "",
                f"Example {prefix}_canonical_check :",
                f"  elf64_residency_image_check {wp8e_target}",
                f"    {prefix}_image = true.",
                "Proof. vm_compute. reflexivity. Qed.",
                "",
                ...
                f"    {prefix}_image.",
                "Proof.",
                "  apply elf64_residency_image_check_sound.",
