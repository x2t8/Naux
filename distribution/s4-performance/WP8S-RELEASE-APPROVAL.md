Public, reproducible Scope 4 paired-measurement evidence for the exact tracked commit `56b6447a13ac648c8e35e64daa34ddabb7e0b51c`.

The archive and sealed receipt are inputs for independent WP8R intake and WP8N/WP8O replay.

## Owner-approved observation

Approval status: **approved by repository owner `x2t8` for exact-scope admission**.
...
This public release record is durable approval evidence, not a cryptographic signature. Independent reviewers must still verify the attached archive and receipt and reproduce WP8R/WP8N/WP8O validation.
